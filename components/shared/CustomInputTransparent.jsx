...
const CustomInputTransparent = ({ type, label, id, name, bgColor = 'transparent', bgColorLabel = 'transparent', onChange, value, isRequired = false }) => {
    ...
    return (
        <div className="relative mt-4 w-full h-full">
            ...
            <label
                ...
                style={{ backgroundColor: bgColorLabel }}
                className={`absolute left-[5%] transition-all duration-200  px-1 cursor-text
...
export default CustomInputTransparent;
